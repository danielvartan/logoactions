...
5. Create `netlogo` command (and a `NetLogo` alias on Linux) that invokes the platform's `netlogo-headless` script, facilitating the use of NetLogo in headless mode.
